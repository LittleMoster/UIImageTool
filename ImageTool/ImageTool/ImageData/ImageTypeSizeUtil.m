...
#import "ImageTypeSizeUtil.h"
#import <UIKit/UIKit.h>

@implementation ImageTypeSizeUtil


+ (ImageType)imageTypeOfFilePath:(NSString *)filePath
{

    ImageType type = ImageTypeUnKnow;
...
+ (CGSize)imagSizeOfFilePath:(NSString *)filePath
{
    ...
    ImageType type = [self imageTypeOfFilePath:filePath];
    switch (type) {
        case ImageTypeJPG:
        {
